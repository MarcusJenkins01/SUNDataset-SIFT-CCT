...
def hpo_objective_augmentation(trial, method):
    ...
    if method == "mixup":
        ...
        args.color_jitter = trial.suggest_float("color_jitter", 0, 0.8)
        print("color_jitter", args.color_jitter)
    elif method == "aa":
        args.aa = trial.suggest_categorical("aa", ["rand-m9-mstd0.5-inc1"])
        print("aa", args.aa)

    args.experiment = f"cct_224_14_trial_{method}_{trial.number}"
    args.epochs = 30

    best_metric = run_trial(args, trial)
    return best_metric
